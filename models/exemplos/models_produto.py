...
from .models_user import Empresa
...
class Produto(Base):
    ...
    categoria = relationship('Categoria', backref=db.backref('produtos', cascade='all, delete-orphan'))
    fornecedor = relationship('Fornecedor', backref=db.backref('produtos', cascade='all, delete-orphan'))
    setor = relationship('Setor', backref=db.backref('produtos', cascade='all, delete-orphan'))
...
class EtapaAcompanhamento(Base):
    ...
    etapa = relationship('Etapa', backref=db.backref('acompanhamentos_etapa', lazy='joined'))
    produto = relationship('Produto', backref=db.backref('etapas_acompanhamento', lazy='joined'))
